...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "django-insecure-$zlyb*dm5f#alkv!)#+o=pc7bb^ds9a-sbobl6fj%%k1&=4(1l"
...
if DATABASE_URL:
    # Production: Use DATABASE_URL from environment (likely PostgreSQL on Railway)
    DATABASES = {
        'default': dj_database_url.config(
